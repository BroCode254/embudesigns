...
def initiate_stk_push(request, phoneNo, amountTotal):
    ...
    if isinstance(access_token_response, JsonResponse):
        ...
        if access_token:
            ...
            callback_url = 'https://933f-196-96-113-50.ngrok-free.app/pay/callback/'
            ...
            stk_push_payload = {
                ...
                'Amount': amountTotal,  # Dynamically passed amount
